<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"I:\wamp\www\blog\mine\public/../application/admin\view\permission\admin_permission_add.html";i:1490342181;s:71:"I:\wamp\www\blog\mine\public/../application/admin\view\common\meta.html";i:1490023508;s:73:"I:\wamp\www\blog\mine\public/../application/admin\view\common\footer.html";i:1489832848;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="<?php echo url('admin/permission/admin_permission_save'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">节点URL地址：</label>
			<div class="formControls col-xs-8 col-sm-9">
