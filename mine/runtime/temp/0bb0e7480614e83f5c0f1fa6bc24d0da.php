        ...
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l"><a href="javascript:;" onclick="datadel()"
                    ...
                    class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;"
                                                                  onclick="member_add('添加专题','<?php echo url('admin/topic/topic_add'); ?>','','510')"
                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tr class="text-c">
                        ...
                        <td><u style="cursor:pointer" class="text-primary"
                               onclick="member_show('张三','member-show.html','10001','360','400')"><?php echo $vo['topic_name']; ?></u>
                        </td>
                        <td><?php echo $vo['topic_desc']; ?></td>
                        <td><?php echo $vo['count']; ?></td>
                        <td><?php echo $vo['create_time']; ?></td>
                        <td>
                            <a onclick="member_add('添加文章', '<?php echo url('topic/add_article_to_topic'); ?>', '', '510')">
                        ...
                        <td class="td-manage"><a style="text-decoration:none" onClick="member_stop(this,'10001')"
                            ...
                            <a title="编辑" href="javascript:;"
                               onclick="member_edit('编辑','<?php echo url('admin/topic/topic_edit', ['id'=>$vo['id']]); ?>','4','','510')"
