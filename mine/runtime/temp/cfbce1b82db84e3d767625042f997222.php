<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"I:\wamp\www\blog\mine\public/../application/admin\view\permission\admin_role_add.html";i:1490344403;s:71:"I:\wamp\www\blog\mine\public/../application/admin\view\common\meta.html";i:1490023508;s:73:"I:\wamp\www\blog\mine\public/../application/admin\view\common\footer.html";i:1489832848;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="<?php echo url('admin/permission/admin_role_save'); ?>" method="post" class="form form-horizontal" id="form-admin-role-add">
		<div class="row cl">
					...
					<dd>
						<dl class="cl permission-list2">
							...
							<dd>
								...
								<label class="">
									<input type="checkbox" value="<?php echo $vo['id']; ?>" name="rules[]" id="user-Character-0-0-0">
