<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\phpStudy\WWW\tp5\public/../application/index\view\index\xq.html";i:1489730552;}*/ ?>
﻿<!DOCTYPE html>
<html>
    <head>
...
<link rel="stylesheet" href="_index_/css/product.css">
	...
	<div class="shop-position">
		<div class="shop-img">
			<a href="/shop?shopId=297" class="shop-img-wrap" target="_blank" data-position-id="3000022">
				<img src="_index_/img/564b6f04c88d4840b81bc86dbbb68e55.gif" alt="badina服饰" title="badina服饰" onerror="this.src = '/_index_/img/widget/img_loading_450_450.png'; this.onerror = null; ">
			</a>
		</div>
		...
		<div class="shop-detail" data-id="297">
			...
			<div class="shop-cus J_talk" data-ucid="11118190" data-siteid="7481623" >
				<img class="custom-service" src="_index_/img/custom_service2.gif"/>
				<span>客服</span>
			</div>
...
<div class="description_info comWidth">
    ...
    <div class="gallery-thumbs">
                    ...
                    <div class="product-swiper-slide swiper-slide-active 0"  index="0">
                                <img src="_index_/img/0f00057f9vzf15sfkcgpo0.jpg">
                        <span class="icon-four-corner"></span>
                    </div>
                    <div class="product-swiper-slide 1"   index="1">
                                <img src="_index_/img/0f000c3lj8pn6tln0s9nn0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                        <span class="icon-four-corner"></span>
                    </div>
                    <div class="product-swiper-slide 2"   index="2">
                                <img src="_index_/img/0f000nzlyi7l6qmwbrnqd0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                        <span class="icon-four-corner"></span>
                    </div>
                    <div class="product-swiper-slide 3"   index="3">
                                <img src="_index_/img/0f0007zokeqypyjwqpg220.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                        <span class="icon-four-corner"></span>
                    </div>
    </div>
    ...
    <div class="gallery-top product-swiper-container">
        <div class="product-swiper-wrapper">
                    ...
                    <a class="product-swiper-slide 0 swiper-slide-active" >
                                <img src="_index_/img/0f000c3lj_ln6tln0s9ny0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                    </a>

                    <a class="product-swiper-slide 1" >
                                <img src="_index_/img/0f000c3ljcjn6tln0s9nz0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                    </a>

                    <a class="product-swiper-slide 2" >
                                <img src="_index_/img/0f000nzlyfdl6qmwbrnqo0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                    </a>

                    <a class="product-swiper-slide 3" >
                                <img src="_index_/img/0f0007zokseypyjwqpg2q0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦">
                    </a>
    ...
    <div class="product-swiper-container small-box gallery-top">
        ...
        <div class="product-swiper-wrapper">
                    <a class="product-swiper-slide 0 swiper-slide-active" >
                                <img src="_index_/img/0f000c3lj_ln6tln0s9ny0.jpg" data-srcmi="http://ipcmm.baidu.com/media/v1/0f000c3lj_lN6Tln0s9ny0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
                    </a>

                    <a class="product-swiper-slide 1" >
                                <img src="_index_/img/0f000c3ljcjn6tln0s9nz0.jpg" data-srcmi="http://ipcmm.baidu.com/media/v1/0f000c3ljCJN6Tln0s9nZ0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
                    </a>

                    <a class="product-swiper-slide 2" >
                                <img src="_index_/img/0f000nzlyfdl6qmwbrnqo0.jpg" data-srcmi="http://ipcmm.baidu.com/media/v1/0f000nZlyfdl6QMWBrNQO0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
                    </a>

                    <a class="product-swiper-slide 3" >
                                <img src="_index_/img/0f0007zokseypyjwqpg2q0.jpg" data-srcmi="http://ipcmm.baidu.com/media/v1/0f0007ZokSeypYjWqPG2q0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
                    </a>
    ...
    <div class="des_smimg gallery-thumbs">
                    <div class="product-swiper-slide swiper-slide-active 0"  index="0">
                                <img src="_index_/img/0f00057f9vzf15sfkcgpo0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
                        <span class="icon-four-corner"></span>
                    </div>
                    <div class="product-swiper-slide 1" index="1">
                                <img src="_index_/img/0f000c3lj8pn6tln0s9nn0.jpg" alt="芭蒂娜2015欧洲站秋季新品 拼接长袖印花秋装a字连衣裙 修身显瘦" >
	...
	<div class="postAge">
									...
									<dd class="clearfix ">
										<div class="para-dd">
												...
												<div class="des_item " title="红印花" data-pid="28" data-vid="红印花" data-srcsi="http://ipcmm.baidu.com/media/v1/0f000AjobfdIN2MAoX7DO0.jpg" data-srcmi="http://ipcmm.baidu.com/media/v1/0f000FMoeNUFHhgM5dGZy0.jpg" data-srcli="http://ipcmm.baidu.com/media/v1/0f000FMoeReFHhgM5dGZf0.jpg" >
															<img class="color-img" title="红印花" src="_index_/img/0f000ajobf7in2maox7dt0.jpg" alt="红印花"></img>
		...
		<div class="comWidth big-box-contain">
		    <div id="big-box">
		                        ...
		                        <img class="big-img big-img-show" data-id="0" src="_index_/img/0f000c3ljvpn6tln0s9nf0.jpg" data-srcli="http://ipcmm.baidu.com/media/v1/0f000c3ljVpN6Tln0s9nf0.jpg" alt="http://ipcmm.baidu.com/media/v1/0f000c3ljVpN6Tln0s9nf0.jpg">
		                        <img class="big-img" data-id="1" src="_index_/img/0f000c3ljg2n6tln0s9nk0.jpg" data-srcli="http://ipcmm.baidu.com/media/v1/0f000c3ljG2N6Tln0s9nK0.jpg" alt="http://ipcmm.baidu.com/media/v1/0f000c3ljG2N6Tln0s9nK0.jpg">
		                        <img class="big-img" data-id="2" src="_index_/img/0f000nzlywnl6qmwbrnq40.jpg" data-srcli="http://ipcmm.baidu.com/media/v1/0f000nZlywNl6QMWBrNQ40.jpg" alt="http://ipcmm.baidu.com/media/v1/0f000nZlywNl6QMWBrNQ40.jpg">
		                        <img class="big-img" data-id="3" src="_index_/img/0f0007zoksuypyjwqpg2o0.jpg" data-srcli="http://ipcmm.baidu.com/media/v1/0f0007ZokSUypYjWqPG2O0.jpg" alt="http://ipcmm.baidu.com/media/v1/0f0007ZokSUypYjWqPG2O0.jpg">
		    </div>
