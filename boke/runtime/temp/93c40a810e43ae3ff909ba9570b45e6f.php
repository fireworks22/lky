<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"D:\phpStudy\WWW\boke\public/../application/admin\view\picture\picture_add.html";i:1490058549;s:70:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\meta.html";i:1489980007;s:72:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\footer.html";i:1489978598;}*/ ?>
...
<title>新增专题</title>
<link href="_admin_/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">专题作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">专题来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="0" placeholder="" id="" name="">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">专题摘要：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<div id="filePicker">选择专题</div>
					<button id="btn-star" class="btn btn-default btn-uploadstar radius ml-10">开始上传</button>
				</div>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">专题上传：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            // 禁掉全局的拖拽功能。这样不会出现专题拖进页面的时候，把专题打开。
        ...
        function updateStatus() {
            ...
            if ( state === 'ready' ) {
                text = '选中' + fileCount + '张专题，共' +
                        WebUploader.formatSize( fileSize ) + '。';
            } else if ( state === 'confirm' ) {
                stats = uploader.getStats();
                if ( stats.uploadFailNum ) {
                    text = '已成功上传' + stats.successNum+ '张照片至XX相册，'+
                        stats.uploadFailNum + '张照片上传失败，<a class="retry" href="#">重新上传</a>失败专题或<a class="ignore" href="#">忽略</a>'
                }
