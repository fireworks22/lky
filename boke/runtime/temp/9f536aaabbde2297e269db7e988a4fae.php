<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\phpStudy\WWW\boke\public/../application/admin\view\article\article_list.html";i:1491964742;s:70:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\meta.html";i:1490322010;s:72:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\header.html";i:1489988118;s:70:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\menu.html";i:1490057926;s:72:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\footer.html";i:1489978598;}*/ ?>
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
				...
				<a class="btn btn-primary radius" data-title="添加文章" _href="<?php echo url('admin/article/article_add'); ?>" onclick="article_add('添加文章','<?php echo url('admin/article/article_add'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a>
				</span>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered">
                    ...
                    <tr class="text-c">
                        ...
                        <td class="text-l">
                            <u style="cursor:pointer" class="text-primary" onClick="article_edit('查看','article-zhang.html','10001')" title="查看"><?php echo $vo['title']; ?></u></td>
                        ...
                        <td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'10001')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
                            <a style="text-decoration:none" class="ml-5" onClick="article_edit('文章编辑','<?php echo url('admin/article/article_edit',['id'=>$vo['id']]); ?>','10001')" href="javascript:;" title="编辑">
