<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:84:"D:\phpStudy\WWW\boke\public/../application/admin\view\category\product_category.html";i:1490325536;s:70:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\meta.html";i:1490322010;s:72:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\header.html";i:1489988118;s:70:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\menu.html";i:1490057926;s:72:"D:\phpStudy\WWW\boke\public/../application/admin\view\common\footer.html";i:1489978598;}*/ ?>
﻿
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		...
		<article class="cl pd-20">
			<div id="nan"><span>提示：点击树节点可删除该节点</span></div>
			<table class="table">
				<tr>
					<td width="200" class="va-t">
						<ul id="treeDemo" class="ztree"></ul>
					</td>
					<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<?php echo url('admin/category/product_category_add'); ?>"></iframe></td>
				</tr>
			</table>
		</article>
	</div>
	...
	callback: {
		beforeClick: function(treeId, treeNode) {
            layer.confirm('确认要删除吗？',function(data){
                $.ajax({
                    url:"<?php echo url('admin/category/category_del_ajax'); ?>",
                    type:"GET",
                    dataType:"json",
                    data:"id="+treeNode.id,
                    success:function (data) {
                        if(data){
                            ...
                            location.href = "<?php echo url('admin/category/product_category'); ?>";
						}else {
...
$.ajax({
    url:"<?php echo url('admin/category/category_list_tree'); ?>",
	dataType:"json",
	type:"GET",
	success:function(data) {
        var t = $("#treeDemo");
