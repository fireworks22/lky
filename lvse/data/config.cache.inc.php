...
$cfg_basehost = 'http://127.0.0.11';
$cfg_cmspath = '';
$cfg_cookie_encode = 'P7C7lno1nOvKBlRVPERoSUPNv3kmf';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '';
$cfg_webname = '荧光增白剂|邻氨基苯酚|邻硝基苯酚|邻氨基对叔丁基苯酚|噻吩-2,5-二羧酸|对苯二甲醛';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 济南塑邦精细化工有限公司 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '荧光增白剂,邻氨基苯酚,邻硝基苯酚,邻氨基对叔丁基苯酚,噻吩-2,5-二羧酸,对苯二甲醛,荧光增白剂厂家,荧光增白剂价格';
$cfg_description = '';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
...
$cfg_entitle = 'Fluorescent Brightener | o-aminophenol | nitrophenol | o-tert-butyl phenol | thiophene 2,5 - dicarboxylic acid | terephthaldehyde - Jinan Subang Fine Chemical Co., Ltd.';
$cfg_enkey = 'Fluorescent brighteners, o-aminophenol, o-nitro phenol, o-tert-butyl phenol, thiophene 2,5 - dicarboxylic acid, terephthalic formaldehyde, fluorescent brighteners manufacturers, optical brighteners price';
$cfg_endes = 'Jinan Subang Fine Chemical Co., Ltd. is a professional production of optical brighteners, o-aminophenol, o-nitro phenol, o-tert-butyl phenol, thiophene-2, 5 - dicarboxylic acid, terephthalic formaldehyde and other chemical supplies manufacturers. Over the years, Jinan Subang Fine Chemical with high-quality, cardiac services developed very rapidly, products sold at home and abroad over 50 countries and regions, much industry acclaim.';
?>