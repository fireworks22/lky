<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"I:\wamp\www\tp\blog\public/../application/admin\view\category\category_list.html";i:1490151205;s:69:"I:\wamp\www\tp\blog\public/../application/admin\view\common\meta.html";i:1489977837;s:71:"I:\wamp\www\tp\blog\public/../application/admin\view\common\header.html";i:1490585699;s:69:"I:\wamp\www\tp\blog\public/../application/admin\view\common\menu.html";i:1490067822;s:71:"I:\wamp\www\tp\blog\public/../application/admin\view\common\footer.html";i:1489980096;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
		...
		<article class="cl pd-20">
			<table class="table">
				<tr>
					...
					<td class="va-t"><iframe ID="testIframe" Name="testIframe" FRAMEBORDER=0 SCROLLING=AUTO width=100%  height=390px SRC="<?php echo url('admin/category/category_add'); ?>"></iframe></td>
				</tr>
			</table>
		</article>
	</div>
				...
				$.ajax({
					...
					success: function (data) {
						if(data){
							...
							location.href = "<?php echo url('admin/category/category_list'); ?>";
						}else{
